...
\begin{subfigure}{0.5\textwidth}
  \includegraphics[width=\linewidth]{fig_ingredient_diff.png}
  \caption{Italian-mean minus American-mean TF-IDF for the $40$ ingredients, sorted.}
  \label{fig:ingdiff}
\end{subfigure}\hfill
\begin{subfigure}{0.40\textwidth}
  \includegraphics[width=\linewidth]{fig_n_ingredients.png}
...
\begin{table}[h]
\centering\small
\input{tab_model_comparison.tex}
...
\begin{figure}[h]
\centering
\IfFileExists{fig_shap_summary.png}{
  ...
  \begin{subfigure}{0.50\textwidth}
    \includegraphics[width=\linewidth]{fig_shap_summary.png}
  ...
  \end{subfigure}}
{
  \includegraphics[width=0.62\linewidth]{fig_feature_importance.png}
}
