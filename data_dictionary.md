...
Data itself is not included in this repository — see the Data Note in the main README.

| Column | Type | Description |
|---|---|---|
| `y` | categorical (train only) | Cuisine label<br>`1` = American, `2` = Italian. Not present in the test rows. |
